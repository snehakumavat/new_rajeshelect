...
include("session.php");
	...
	$up_e = 0;
	$up_e=$_REQUEST['e_id2'];
	$up_qry="select * from service_tax where id=".$up_e;
	...
	{	
		...
		$qry_up="update service_tax SET s_id1='".$t_no."', details='".$t_term."' where s_id=".$up;
...
<div id="sub-header">	
	...
	include("header.php");
	?><br />
		<div class="quotation"><center>Update Tax Details</center></div>
        <div>
        ...
        <tr>
        <td valign="top" class="l_form">Service Tax Details:</td>
