...
include("session.php");
	...
	if(isset($_REQUEST['e_add']))
	{
		...
		$refno=$_POST['refno'];
		 ...
		 $pa_qry="insert into partial_payment(i_id,c_id,c_name,p_mode,c_no,p_date,i_amt,p_amt,bank_nm,remark,refno) values('".$p_t1."','".$c."','".$p_t2."','".$p_t3."','".$p_t4."','".$p_t5."','".$p_t7."','".$p_t6."','".$p_t8."','".$p_t9."','".$refno."')"; 
//		exit();
...
<div id="sub-header">	
	...
	?><br /><div class="quo">
        ...
        <td><input id="i_amt" type="text" class="q_in" name="t7" value="<?php echo $row_pid[0]; ?>"></td>
         ...
         <tr>
        <td class="l_form">Payment Amount:</td>
      ...
      <td><input id="bnk" type="text" class="q_in" name="bnk" value=""></td>
        ...
        <tr>
        <td class="l_form">Ref No:</td>
        <td><input id="refno" type="text" class="q_in" name="refno"></td>
        </tr>
        ...
        <tr>
        <td class="l_form">Remaining/Balance Amt:</td>
