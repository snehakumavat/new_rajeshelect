...
<br />
    ...
    <div class="page">
			...
			$to_f=date('Y-02-28');
		 $qry_f="select * from income where p_date >='".$from_f."' and p_date<='".$to_f."'";
			$res_f=mysql_query($qry_f);
			
			$qry_fe="select SUM(p_amt) from income where p_date >='".$from_f."' and p_date<='".$to_f."'";
        ...
        <div class="exp">Total Income Details This Month&nbsp;:&nbsp;<?php echo $row_fe[0].'&nbsp;'.Rs.'/'.'-'; ?></div>
			...
			$to_ma=date('Y-03-31');
			$qry_ma="select * from income where p_date >='".$from_ma."' and p_date<='".$to_ma."'";
			$res_ma=mysql_query($qry_ma);
			
			$qry_me="select SUM(p_amt) from income where p_date >='".$from_ma."' and p_date<='".$to_ma."'";
        ...
        <div class="exp">Total Income Details This Month&nbsp;:&nbsp;<?php echo $row_me[0].'&nbsp;'.Rs.'/'.'-'; ?></div>
			...
			$to_ap=date('Y-04-31');
			$qry_ap="select * from income where p_date >='".$from_ap."' and p_date<='".$to_ap."'";
			$res_ap=mysql_query($qry_ap);
			
			$qry_ae="select SUM(p_amt) from income where p_date >='".$from_ap."' and p_date<='".$to_ap."'";
			...
			$from_j=date('Y-01-01');
			$to_j=date('Y-01-31');
			$qry_j="select * from income where p_date >='".$from_j."' and p_date<='".$to_j."'";
			$res_j=mysql_query($qry_j);
			
			$qry_je="select SUM(p_amt) from income where p_date >='".$from_j."' and p_date<='".$to_j."'";
        ...
        <div class="exp">Total Income Details This Month&nbsp;:&nbsp;<?php echo $row_je[0].'&nbsp;'.Rs.'/'.'-'; ?></div>
			...
			$from_m=date('Y-05-01');
			$to_m=date('Y-05-31');
			$qry_m="select * from income where p_date >='".$from_m."' and p_date<='".$to_m."'";
			$res_m=mysql_query($qry_m);
			
			$qry_em="select SUM(p_amt) from income where p_date >='".$from_m."' and p_date<='".$to_m."'";
        ...
        <div class="exp">Total Income Details This Month&nbsp;:&nbsp;<?php echo $row_em[0].'&nbsp;'.Rs.'/'.'-'; ?></div>
			...
			$to_ju=date('Y-06-31');
			$qry_ju="select * from income where p_date >='".$from_ju."' and p_date<='".$to_ju."'";
			$res_ju=mysql_query($qry_ju);
			
			$qry_jue="select SUM(p_amt) from income where p_date >='".$from_ju."' and p_date<='".$to_ju."'";
        ...
        <div class="exp">Total Income Details This Month&nbsp;:&nbsp;<?php echo $row_jue[0].'&nbsp;'.Rs.'/'.'-'; ?></div>
			...
			$to_jl=date('Y-07-31');
			$qry_jl="select * from income where p_date >='".$from_jl."' and p_date<='".$to_jl."'";
			$res_jl=mysql_query($qry_jl);
			
			$qry_le="select SUM(p_amt) from income where p_date >='".$from_jl."' and p_date<='".$to_jl."'";
        ...
        <div class="exp">Total Income Details This Month&nbsp;:&nbsp;<?php echo $row_le[0].'&nbsp;'.Rs.'/'.'-'; ?></div>
			...
			$to_au=date('Y-08-31');
			$qry_au="select * from income where p_date >='".$from_au."' and p_date<='".$to_au."'";
			$res_au=mysql_query($qry_au);
			
			$qry_aue="select SUM(p_amt) from income where p_date >='".$from_au."' and p_date<='".$to_au."'";
        ...
        <div class="exp">Total Income Details This Month&nbsp;:&nbsp;<?php echo $row_aue[0].'&nbsp;'.Rs.'/'.'-'; ?></div>
			...
			$to_se=date('Y-09-31');
			$qry_se="select * from income where p_date >='".$from_se."' and p_date<='".$to_se."'";
			$res_se=mysql_query($qry_se);
			
			$qry_see="select SUM(p_amt) from income where p_date >='".$from_se."' and p_date<='".$to_se."'";
        ...
        <div class="exp">Total Income Details This Month&nbsp;:&nbsp;<?php echo $row_see[0].'&nbsp;'.Rs.'/'.'-'; ?></div>
			...
			$from_o=date('Y-10-01');
			$to_o=date('Y-10-31');
			$qry_o="select * from income where p_date >='".$from_o."' and p_date<='".$to_o."'";
			$res_o=mysql_query($qry_o);
			
			$qry_oe="select SUM(p_amt) from income where p_date >='".$from_o."' and p_date<='".$to_o."'";
        ...
        <div class="exp">Total Income Details This Month&nbsp;:&nbsp;<?php echo $row_oe[0].'&nbsp;'.Rs.'/'.'-'; ?></div>
			...
			$from_n=date('Y-11-01');
			$to_n=date('Y-11-31');
			$qry_n="select * from income where p_date >='".$from_n."' and p_date<='".$to_n."'";
			$res_n=mysql_query($qry_n);
			
			$qry_ne="select SUM(p_amt) from income where p_date >='".$from_n."' and p_date<='".$to_n."'";
        ...
        <div class="exp">Total Income Details This Month&nbsp;:&nbsp;<?php echo $row_ne[0].'&nbsp;'.Rs.'/'.'-'; ?></div>
			...
			$from_d=date('Y-12-01');
			$to_d=date('Y-12-31');
			$qry_d="select * from income where p_date >='".$from_d."' and p_date<='".$to_d."'";
			$res_d=mysql_query($qry_d);
			
			$qry_de="select SUM(p_amt) from income where p_date >='".$from_d."' and p_date<='".$to_d."'";
