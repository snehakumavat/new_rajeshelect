...
if (agree)
	...
	$("#content").load("homepage.php?page=1", Hide_Load());
	...
	$("#pagination li").click(function(){
		...
		//Loading Data
		var pageNum = this.id;
		$("#content").load("homepage.php?page=" + pageNum, Hide_Load());
...
?>
				...
				<table class="emp_tab">
                <tr  class="search_res">
                <td class="info" width="950px">GatePass Details</td>
                <td width="300px;" ><input type='text' name="search" class="result" title="Enter gatepass no,date,approver name,status here.." />
